...
function App() {
  ...
  return (
    <>
      <div className="h-screen flex justify-end items-center pr-24">
        <div
          className="rounded-lg bg-white p-5 text-gray-700"
          style={{ maxWidth: "600px" }}
        >
          <div className="w-full pt-1 pb-5">
            <div className="bg-indigo-500 text-white overflow-hidden rounded-full w-16 h-16 -mt-10 mx-auto shadow-lg flex justify-center items-center">
